...
export const tasksData: Task[] = [
  { id: 'tk-1', title: 'Follow up with Alice Thompson', description: 'Call regarding Sunset Retreat Villa offer', category: 'follow-up', priority: 'high', completed: false, dueDate: '2026-03-10', assignedAgentId: 'ag-1', assignedAgentName: 'Sarah Chen' },
  { id: 'tk-2', title: 'Schedule inspection — Lakefront Manor', description: 'Coordinate with inspector and buyer', category: 'inspection', priority: 'high', completed: false, dueDate: '2026-03-11', assignedAgentId: 'ag-5', assignedAgentName: 'Elena Vasquez' },
  { id: 'tk-3', title: 'Prepare purchase agreement', description: 'Ocean Breeze Cottage — Robert Kim', category: 'paperwork', priority: 'medium', completed: true, dueDate: '2026-03-07', assignedAgentId: 'ag-3', assignedAgentName: 'Priya Nair' },
  { id: 'tk-4', title: 'Showing — Desert Modern 2pm', description: 'Show property to Fontaine family', category: 'showing', priority: 'medium', completed: false, dueDate: '2026-03-12', assignedAgentId: 'ag-4', assignedAgentName: 'James Okafor' },
  { id: 'tk-5', title: 'Submit closing docs — Mountain View', description: 'Final paperwork to escrow', category: 'paperwork', priority: 'high', completed: true, dueDate: '2026-03-06', assignedAgentId: 'ag-2', assignedAgentName: 'Marcus Webb' },
  { id: 'tk-6', title: 'Send market analysis to Ben Caldwell', description: 'Comparative market analysis for Boulder area', category: 'follow-up', priority: 'low', completed: false, dueDate: '2026-03-14', assignedAgentId: 'ag-1', assignedAgentName: 'Sarah Chen' },
  { id: 'tk-7', title: 'Update MLS listing — Riverside Haven', description: 'New photos and updated description', category: 'other', priority: 'medium', completed: false, dueDate: '2026-03-13', assignedAgentId: 'ag-6', assignedAgentName: 'Tom Nakamura' },
]
